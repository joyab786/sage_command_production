...
try:
    ...
    from backend.core.config import DEFAULT_DB_PATH

def init_simulator_db(db_path: str = DEFAULT_DB_PATH):
...
def inject_random_anomaly(db_path: str = DEFAULT_DB_PATH) -> Dict[str, Any]:
